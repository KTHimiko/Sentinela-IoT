...
// configureDistributedMode reads MODO, SENTINELA_TOKEN and AGENTES, and
...
func configureDistributedMode() (mode string, agents []remoteAgent) {
	...
	apiToken = os.Getenv("SENTINELA_TOKEN")
	if apiToken == "" {
		fmt.Printf("MODO=%s ignorado: defina SENTINELA_TOKEN com um segredo compartilhado entre a central e os agentes.\n", mode)
